...
"""
    MP3 Tag Editor using the wxPython package
    writen by Gabriel Heberle on December 21st, 2021 (based on https://realpython.com/python-gui-with-wxpython/)
"""
...
class EditDialog(wx.Dialog):
    ...
    def add_widgets(self, label_text, text_ctrl) -> None:
...
class Mp3Panel(wx.Panel):
    ...
    def update_mp3_listing(self, folder_path) -> None:
